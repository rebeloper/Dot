...
public extension ParticlesEmitterView {
    ...
    func emitterPosition(_ position: CGPoint) -> Self {
        return ParticlesEmitterView(center: position, emitterSize: self.emitterSize, shape: shape, cells: self.cells)
    }
    
    func emitterShape(_ shape: CAEmitterLayerEmitterShape) -> Self {
        return ParticlesEmitterView(center: self.center, emitterSize: self.emitterSize, shape: shape, cells: self.cells)
    }
}
